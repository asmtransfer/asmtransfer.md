...
document.addEventListener('DOMContentLoaded', () => {
  ...
  style.textContent = `
    ...
    .calculator-search{width:100%;height:48px;margin-bottom:8px;border-radius:10px;border:1px solid rgba(255,255,255,.14);background:#0d0d0f;color:#fff;padding:0 14px;font:inherit;outline:none}.calculator-search:focus{border-color:#f3c400}.calculator-search:disabled{opacity:.5}.calculator-swap{width:100%;min-height:44px;margin:-2px 0 16px;border:1px solid rgba(243,196,0,.45);border-radius:10px;background:rgba(243,196,0,.08);color:#f3c400;font:inherit;font-weight:900;cursor:pointer}.calculator-swap:hover{background:rgba(243,196,0,.15)}.calculator-custom{display:block;margin-top:14px;color:#f3c400;font-size:14px;font-weight:850;text-decoration:none}.calculator-custom:hover{text-decoration:underline}
