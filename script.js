...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (routesSection) {
    ...
    to.addEventListener('change', () => {
      ...
      const msg = `Здравствуйте! Хочу заказать трансфер ASM Transfer: ${r[0]} → ${r[1]}. На сайте указана предварительная стоимость ${r[2]}. Если бронирование за 7 дней и более, прошу учесть скидку 10%. Подтвердите, пожалуйста, актуальную цену и возможность поездки.`;
